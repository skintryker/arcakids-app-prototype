...
- Música de fundo ajustada para tocar como melodia suave em vez de bipes curtos.
- Logo Arcakids incorporado e experiência nomeada como Arca Digital.
- Teste grátis de 7 dias com desbloqueio local das opções premium.
...
1. Validar nomes, visual e proposta com os pais.
2. Definir quais jogos entram no MVP real.
3. Criar identidade visual final com personagens Arcakids.
4. Migrar para React Native/Expo para iPhone e Android.
5. Planejar assinatura, privacidade infantil e publicação nas lojas.
